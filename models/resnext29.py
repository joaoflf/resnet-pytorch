...
class ResNeXt(nn.Module):
    ...
    def __init__(self,
        ...
        self.output_size = 64
        self.stages = [
            64, 64 * self.expansion, 128 * self.expansion, 256 * self.expansion
        ]
    ...
    def block(self, name, in_channels, out_channels, pool_stride=2):
        ...
        for bottleneck in range(self.block_depth):
            ...
            if bottleneck == 0:
                ...
                block.add_module(
                    name_,
                    Bottleneck(out_channels, out_channels, 1, self.cardinality,
...
def resnext29_8x64d(num_classes):
    return ResNeXt(
        cardinality=8, depth=29, num_classes=num_classes, base_width=64)


def resnext29_16x64d(num_classes):
    return ResNeXt(
        cardinality=16, depth=29, num_classes=num_classes, base_width=64)
