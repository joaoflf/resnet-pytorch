...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, input_channels, output_channels, downsampling=False,
                 bottleneck=False, bottleneck_factor=4, pre_activation=False):
        super().__init__()
        ...
        if bottleneck:
            if pre_activation:
                self.model = nn.Sequential(
                    ...
                    nn.ReLU(),
                    nn.Conv2d(input_channels, bottleneck_channels,
                              kernel_size=1, stride=stride, padding=0),
                    ...
                    nn.BatchNorm2d(bottleneck_channels),
                    nn.ReLU(),
                    nn.Conv2d(bottleneck_channels, output_channels,
...
class ResNet50(nn.Module):
    ...
    def __init__(self, num_classes, pre_activation=False):
        ...
        self.model = nn.Sequential(
            ...
            ResidualBlock(256, 256, bottleneck=True,
                          pre_activation=pre_activation),
            ResidualBlock(256, 512, bottleneck=True, downsampling=True,
                          bottleneck_factor=2, pre_activation=pre_activation),
            ...
            ResidualBlock(512, 512, bottleneck=True,
                          pre_activation=pre_activation),
            ResidualBlock(512, 1024, bottleneck=True, downsampling=True,
                          bottleneck_factor=2, pre_activation=pre_activation),
            ...
            ResidualBlock(1024, 1024, bottleneck=True,
                          pre_activation=pre_activation),
            ResidualBlock(1024, 2048, bottleneck=True, downsampling=True,
                          bottleneck_factor=2, pre_activation=pre_activation),
