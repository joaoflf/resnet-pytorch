...
class DogsDataset(Dataset):
    ...
    def __init__(self, root_dir, transform=None, train=True):
        ...
        self.images = [root_dir + '/Images/' + val for sublist in images for val in sublist]
...
class DogsDataLoader():
    def __init__(self):
        ...
        dataset_test = DogsDataset('./dataloaders/datasets/dogs', transform=transform, train=False)
